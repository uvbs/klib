...
#ifndef _SF_SERIALIZESTATICARRAY_HPP_
#define _SF_SERIALIZESTATICARRAY_HPP_
...
namespace SF {
    ...
    {
        static const bool IsFundamental = boost::is_fundamental<T>::value;
        SerializeStaticArray<IsFundamental>()(ar, pt, version);
    }

} // namespace SF

#endif // ! _SF_SERIALIZESTATICARRAY_HPP_
